          ...
          >
            <div className="flex items-center">
              <div className="ml-4 relative inline-block  ">
                ...
                {isActiveId === nail.id && (
                  <div className="absolute top-0 left-0  w-96 bg-primary-700 text-accent-700 m-4 p-3 border-2 border-accent-700 rounded z-10 ">
                    <p
                      onClick={() => toggleDescription(null)}
                      className=" text-end p-1 m-2 rounded-md text-accent-800 cursor-pointer"
                    >
                      X
                    </p>
                    <div className="flex mx-auto h-60 relative  aspect-square">
                      <Image
                    ...
                    <p className="m-2 p-1">{nail.description}</p>
                  </div>
                )}
              </div>
            </div>
