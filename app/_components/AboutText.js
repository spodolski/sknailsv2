...
function AboutText() {
  return (
    <>
      ...
      <main>
        <div
          className="h-[350px] relative aspect-square float-left mr-8 mb-6"
        ...
        15px; font-size: 115%; */}
        <p className="text-justify text-accent-600 mb-4 leading-8 text-lg">
        ...
        <ul className="text-justify text-accent-600 mb-4 ml-6 leading-8 text-lg list-disc">
